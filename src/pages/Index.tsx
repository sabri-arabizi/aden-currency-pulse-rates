...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-900 via-yellow-900 to-amber-800 py-0 relative">
      {/* Background Logo */}
      <div className="fixed bottom-4 left-4 z-0 opacity-20">
        <img 
          src="/lovable-uploads/53f2e558-f1d9-467f-88bf-47f6983e46bb.png" 
          alt="Background Logo"
        ...
        <div className="text-center mb-6 md:mb-10">
          ...
          <div className="flex justify-center gap-4 md:gap-8 mb-6 md:mb-10 px-4 mx-auto py-4 rounded-full backdrop-blur-sm bg-[#ffd100]/85">
            <button 
              ...
              className={`relative transition-all duration-500 group ${selectedCity === 'صنعاء' ? 'transform scale-110' : 'hover:transform hover:scale-105'}`}
            >
            ...
            <button 
              ...
              className={`relative transition-all duration-500 group ${selectedCity === 'عدن' ? 'transform scale-110' : 'hover:transform hover:scale-105'}`}
            >
      ...
      <div className="fixed bottom-0 left-0 right-0 backdrop-blur-md border-t border-white/20 px-4 py-3 md:py-4 shadow-2xl safe-area-inset-bottom bg-amber-900/50 z-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-3 gap-2 md:gap-4 text-center">
            <Link 
              to="/contact" 
              className="flex flex-col items-center gap-1 md:gap-2 text-yellow-400 hover:text-yellow-300 transition-all duration-300 group p-2"
            >
