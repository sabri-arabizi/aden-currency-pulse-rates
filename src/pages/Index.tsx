...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-0 rounded bg-amber-900">
      {/* Header */}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-white/20 px-4 py-3 md:py-4 shadow-2xl safe-area-inset-bottom">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-3 gap-2 md:gap-4 text-center">
            <Link 
              to="/contact" 
              className="flex flex-col items-center gap-1 md:gap-2 text-purple-600 hover:text-purple-700 transition-all duration-300 group p-2"
            >
